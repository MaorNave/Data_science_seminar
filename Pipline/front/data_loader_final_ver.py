...
class DataLoaderLocal(Dataset):
    ...
    def __init__(self, dataset_folder):
        ...
        self.main_input_path = "C:\Maor Nanikashvili\data_science_seminar\Pipeline\input\data"
        self.data_loader_list = []
        self.images_list_paths = []
        self.masks_list_paths = []
        self.mean = [0.485, 0.456, 0.406]
        self.std = [0.229, 0.224, 0.225]
        self.config = self.yaml_loader('C:\Maor Nanikashvili\data_science_seminar\Pipeline\input\seg_mapping\color_mapper_config.yml')
